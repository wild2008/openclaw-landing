...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white selection:bg-[#FF5A36] selection:text-white">
      {/* Navigation */}
      <nav className="flex items-center justify-between px-8 py-6 max-w-7xl mx-auto">
        <div className="flex items-center gap-2">
          <div className="w-8 h-8 bg-[#FF5A36] rounded-lg flex items-center justify-center font-bold text-xl">🦞</div>
      ...
      <main className="max-w-7xl mx-auto px-8 pt-20 pb-32">
        <div className="flex flex-col items-center text-center space-y-8">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#1a1a1a] border border-gray-800 text-xs font-medium text-[#FF5A36]">
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-4">
            <button className="bg-[#FF5A36] px-8 py-4 rounded-xl text-lg font-bold hover:bg-[#ff6b4d] hover:scale-105 transition-all shadow-[0_0_20px_rgba(255,90,54,0.3)]">
              Deploy Your Assistant
            </button>
            <button className="bg-[#1a1a1a] border border-gray-800 px-8 py-4 rounded-xl text-lg font-bold hover:bg-[#252525] transition-all">
              Read Documentation
            </button>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 mt-32">
          <div className="bg-[#111] p-8 rounded-2xl border border-gray-800 hover:border-[#FF5A36]/50 transition-colors group">
            <div className="w-12 h-12 bg-[#1a1a1a] rounded-lg flex items-center justify-center mb-6 border border-gray-800 group-hover:bg-[#FF5A36]/10 transition-colors">
              💬
            </div>
      ...
      {/* Footer */}
      <footer className="border-t border-gray-900 py-12 px-8 mt-20">
        <div className="max-w-7xl mx-auto flex flex-col md:row items-center justify-between gap-8">
          <div className="flex items-center gap-2 grayscale opacity-50">
            <div className="w-6 h-6 bg-white rounded flex items-center justify-center text-black font-bold">🦞</div>
